...
class ProductSerializer(serializers.ModelSerializer):
    class Meta:
        model = Product 
        fields = ["id", "name", "slug", "img", "description", "price","category"]
...
class DetailedProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ["id", "name", "price", "slug", "img", "description", "similar_products"]
...
class UserSerializer(serializers.ModelSerializer):
    ...
    # This function is to get the order history of the User up to 10 items
...
class UserUpdateSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        # Those fields are restricted and the user can't update 
